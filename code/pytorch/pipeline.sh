...
python evaluate.py --mode test --model_size $model_size --epochs $epochs --save_every $save_every --beam_num $beam_num --generate_length $generate_length --turn rewrite --lr $lr --mode $mode --data_name $data_name --end_epoch $epochs --start_epoch 0

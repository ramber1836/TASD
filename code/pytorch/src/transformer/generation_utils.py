...
class GenerationMixin:
    ...
    def _expand_inputs_for_generation(
        ...
        **model_kwargs,
        ...
        if semantic_table_ids is not None:
            semantic_table_ids = semantic_table_ids.index_select(0, expanded_return_idx)
        ...
        return input_ids, semantic_table_ids, model_kwargs
    ...
    def generate(
        ...
        **model_kwargs,
        ...
        if is_greedy_gen_mode:
            ...
            input_ids, semantic_table_ids, model_kwargs = self._expand_inputs_for_generation(
                input_ids,
                semantic_table_ids,
            ...
            input_ids, semantic_table_ids, model_kwargs = self._expand_inputs_for_generation(
                input_ids, semantic_table_ids, expand_size=num_beams, is_encoder_decoder=self.config.is_encoder_decoder, **model_kwargs
            )
            # 12. run beam search
    ...
    def greedy_search(
        self,
        input_ids: torch.LongTensor,
        semantic_table_ids: torch.LongTensor,
        ...
        **model_kwargs,
        ...
        while True:
            ...
            model_inputs = self.prepare_inputs_for_generation(input_ids,semantic_table_ids, **model_kwargs)

...
class PretrainedTokenizer(object):
    ...
    @classmethod
    def from_pretrained_local(cls, pretrained_model_name_or_path, *args, **kwargs):
        """
        ...
        """
        init_args = ()
        f = open(pretrained_model_name_or_path + "tokenizer_config.json")
        init_kwargs = json.load(f)
        for key, value in init_kwargs.items():
            init_kwargs[key] = pretrained_model_name_or_path + value
